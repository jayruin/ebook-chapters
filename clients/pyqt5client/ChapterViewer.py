...
from clients.pyqt5client.widgets.ImageViewer import ImageViewer
from clients.pyqt5client.widgets.HTMLViewer import HTMLViewer
from clients.pyqt5client.widgets.NavBar import NavBar
from services.documents.all import CWork, Chapter, WorkType


class ChapterViewer(QtWidgets.QWidget):

    pageChangepyqtSignal = QtCore.pyqtSignal(int)
    ...
    def pageComboBoxOnCurrentIndexChanged(
        ...
        if index >= 0:
            self.pageChangepyqtSignal.emit(index + 1)
